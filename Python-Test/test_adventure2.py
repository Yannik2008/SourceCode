...
time.sleep(1)
Text1 = "Du wachst auf! Deine Augen schmerzen und deine Muskeln sind wie aus Blei. Als du richtig zudir kommst, merkst du, das du auf einer Wiese gelegen hast."
Text = []
Text1.split
print(Text1)